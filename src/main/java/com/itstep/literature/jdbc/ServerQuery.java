package com.itstep.literature.jdbc;
...
public class ServerQuery {
    ...
    /**
     * метод для подключения к серверу MySQL из файла connection.properties
     */
    private ServerQuery() {
    ...
    /**
     * метод получет запрос к серверу MySQL из файла connection.properties по ключу
     *
